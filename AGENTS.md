...
- Settings groups app-wide panels as Settings, Notifications, and Smart Actions, followed by current-board panels ordered General, Labels, Appearance, Workflow, Obsidian, and Import; General includes board rename, move, and duplicate actions.
