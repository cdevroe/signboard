...
Arch Linux and Omarchy users can install the native `.pacman` release package with `sudo pacman -U ./signboard_VERSION_linux_x86_64.pacman`. It includes the launcher entry and icon and does not require FUSE.
