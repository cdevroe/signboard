...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  runSmartBoardAction: (payload) => ipcRenderer.invoke('run-smart-board-action', payload),
  applySmartBoardActionChanges: (payload) => ipcRenderer.invoke('apply-smart-board-action-changes', payload),
  copySmartActionShareLink: (payload) => ipcRenderer.invoke('copy-smart-action-share-link', payload),
  exportSmartActionFile: (payload) => ipcRenderer.invoke('export-smart-action-file', payload),
  importSmartActionFile: () => ipcRenderer.invoke('import-smart-action-file'),
  inspectOllama: (payload) => ipcRenderer.invoke('inspect-ollama', payload),
  inspectAiProvider: (payload) => ipcRenderer.invoke('inspect-ai-provider', payload),
  setAiCredential: (payload) => ipcRenderer.invoke('set-ai-credential', payload),
  clearAiCredential: (provider) => ipcRenderer.invoke('clear-ai-credential', provider),
