  ...
  return [
    {
      ...
      content: [
        ...
        'In report prose and reasons, refer to cards by their human-readable title and list name. Keep raw card IDs only in structured cardId fields; do not make readers identify cards by ID.',
        outputInstruction,
