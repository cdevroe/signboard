...
async function updateAppSettings(userDataPath, partialSettings = {}) {
  ...
  if (Object.prototype.hasOwnProperty.call(partialSettings, 'appearance')) {
    next.appearance = normalizeAppearanceSettings(partialSettings.appearance);
  }
...
module.exports = {
  APP_SETTINGS_FILE_NAME,
  DEFAULT_APPEARANCE_SETTINGS: () => ({ ...DEFAULT_APPEARANCE_SETTINGS }),
  ...
  DEFAULT_SMART_BOARD_ACTIONS: cloneDefaultSmartBoardActions,
  normalizeAppSettings,
  normalizeAppearanceSettings,
  normalizeAiSettings,
  normalizeAiModel,
