...
const MCP_BOARD_VIEW_OPTIONS = Object.freeze([
  ...
  Object.freeze({
    id: 'calendar',
    label: 'Calendar',
    description: 'Month view grouped by card due date.',
  }),
  Object.freeze({
    id: 'this-week',
    label: 'This Week',
    description: 'Current-week view grouped by card due date.',
  }),
]);
...
const TOOL_DEFINITIONS = [
  ...
  },
  {
    ...
    description: 'Duplicate a card into the same list or a target list.',
    inputSchema: {
      type: 'object',
      additionalProperties: false,
      required: ['boardRoot', 'listName', 'cardFile'],
