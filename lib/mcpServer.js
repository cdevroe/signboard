...
const INTERNAL_TOOL_DEFINITIONS = [
  ...
  },
  {
    ...
    description: 'Read board label, theme, and workflow settings from board-settings.md.',
    inputSchema: {
      type: 'object',
      additionalProperties: false,
      required: ['boardRoot'],
  ...
  },
  {
    ...
    description: 'Update board settings (labels, themeOverrides, and/or workflow).',
    inputSchema: {
      type: 'object',
      additionalProperties: false,
      required: ['boardRoot'],
